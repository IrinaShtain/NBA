...
@HiltViewModel
class PlayersListViewModel @Inject constructor(playerRepository: PlayersRepository) :
    ReloadableViewModel() {

    val playersItemsUiStates: Flow<PagingData<PlayerUiModel>> = refreshTrigger.flatMapLatest {
